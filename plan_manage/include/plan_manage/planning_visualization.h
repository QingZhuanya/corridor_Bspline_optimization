...
namespace opt_planner
{
  ...
  public:
    ...
    void displayOptimalList(const vector<Eigen::Vector3d>& optimal_pts, int id);
    ...
    void displaySmoothPathList(const vector<Eigen::Vector3d>& SmoothPath_pts, int id);

private:
    void PublishPath(ros::Publisher &pub, const std::vector<Eigen::Vector3d> &list, double scale, Eigen::Vector4d color, int id);
    void PublishWayPoint(ros::Publisher &pub, const std::vector<Eigen::Vector3d> &list, double scale, Eigen::Vector4d color, int id);
